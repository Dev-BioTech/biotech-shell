    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-biotech-primary to-biotech-secondary rounded-xl p-6 text-white shadow-lg">
        <h1 className="text-3xl font-bold mb-2">
          ¡Bienvenido a Biotech Platform!
        </h1>
        <p className="text-white/90">
          Sistema de gestión biotecnológica de última generación
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-biotech-darker rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-800">
        ...
        <div className="space-y-4">
          {[
            {
              title: "Análisis de muestra #1234 completado",
              time: "Hace 5 minutos",
              type: "success",
            },
            {
              title: "Nuevo experimento iniciado",
              time: "Hace 15 minutos",
              type: "info",
            },
            {
              title: "Reporte generado: Resultados Q4",
              time: "Hace 1 hora",
              type: "default",
            },
            {
            ...
            <div
              key={index}
              className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-biotech-dark transition-colors"
            >
              <div
