    ...
    <div className="w-full px-2 md:px-0">
      ...
      >
        ...
        >
          ...
          <div className="relative h-full flex flex-col justify-center px-6 md:px-8 py-6 md:py-0">
            ...
            <motion.p
              className="text-green-100 text-sm md:text-lg leading-snug md:leading-normal max-w-2xl"
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        {stats.map((stat, index) => (
          ...
          >
            <div
              className={`${stat.bgColor} rounded-2xl shadow hover:shadow-xl transition-all duration-300 p-4 md:p-6 border border-white/50 relative overflow-hidden backdrop-blur-sm`}
            >
              {/* Background Pattern */}
              <div className="absolute top-0 right-0 w-24 h-24 md:w-32 md:h-32 opacity-5 transform translate-x-8 translate-y-[-8px] rotate-12">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3 md:mb-4">
                  <motion.div
                    className={`${stat.iconBg} w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center shadow-lg bg-opacity-90`}
                    whileHover={{ scale: 1.1, rotate: 10 }}
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <stat.icon className="w-5 h-5 md:w-6 md:h-6 text-white" />
                  </motion.div>
                  <div className="flex items-center bg-white/60 backdrop-blur-md px-2 py-0.5 md:px-3 md:py-1 rounded-full border border-white/50 shadow-sm">
                    <TrendingUp className="w-2.5 h-2.5 md:w-3 md:h-3 mr-1 md:mr-1.5 text-green-600" />
                    <span className="text-[10px] md:text-sm font-semibold text-green-700">
                      {stat.trend}
                    </span>
                  </div>
                </div>
                <h3 className="text-xl md:text-3xl font-bold text-gray-800 mb-0.5 md:mb-1">
                  {stat.value}
                </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        >
          <div className="flex items-center justify-between mb-6 md:mb-8 text-center sm:text-left">
            ...
            <button className="text-xs md:text-sm font-medium text-green-600 hover:text-green-700 hover:bg-green-50 px-3 py-1.5 md:px-4 md:py-2 rounded-xl transition-colors">
              Ver todo
            </button>
          </div>
            ...
            {recentActivity.map((activity, index) => (
              ...
              >
                <div className="relative">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-green-100 flex items-center justify-center mr-3 md:mr-4 group-hover:scale-110 transition-transform duration-300">
                    <div
                  ...
                  {index !== recentActivity.length - 1 && (
                    <div className="absolute top-8 left-4 w-0.5 h-full bg-gray-100 -z-10" />
                  )}
                </div>

                <div className="flex-1 min-w-0">
                  <h4 className="text-xs md:text-sm font-bold text-gray-900 group-hover:text-green-700 transition-colors truncate">
                    {activity.action}
                  </h4>
                ...
                <div className="ml-2">
                  <span className="inline-flex items-center justify-center px-2 py-0.5 md:px-3 md:py-1 rounded-full text-[10px] md:text-xs font-medium bg-gray-100 text-gray-600 group-hover:bg-white group-hover:shadow-sm transition-all whitespace-nowrap">
                    {activity.time}
                  </span>
                </div>
              </motion.div>
        ...
        <div className="space-y-6">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-9 h-9 md:w-10 md:h-10 bg-orange-50 rounded-xl flex items-center justify-center">
            ...
            <div className="space-y-3">
              {alerts.map((alert, index) => (
                <motion.div
                  ...
                  className={`p-3 md:p-4 rounded-2xl border transition-all cursor-pointer ${
          ...
          {/* Performance Badge */}
          <motion.div
            className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl md:rounded-3xl shadow-lg p-6 text-white relative overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-9 h-9 md:w-10 md:h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                  <Award className="w-5 h-5 md:w-6 md:h-6 text-white" />
                </div>
                <h3 className="font-bold text-base md:text-lg">Rendimiento</h3>
              </div>
              <div className="flex items-baseline gap-2 mb-2">
                <span className="text-3xl md:text-4xl font-bold">94%</span>
                <span className="text-green-50 text-xs md:text-sm font-medium">
                  Eficiencia
                </span>
              </div>
              <p className="text-xs md:text-sm text-green-50 opacity-90 leading-relaxed">
